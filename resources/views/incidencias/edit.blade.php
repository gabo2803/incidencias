                    ...
                    <div class="col-md-5" data-select2-id="30">
                        <div class="form-group" data-select2-id="29">
                            ...
                            <select readonly="readonly" name="idEquipo" id="equipo"
                                ...
                                <option value="{{ $incidencia->equipo->descripcion }}" title="Seleccione el equipo" >{{ $incidencia->equipo->descripcion }}</option>                                
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2" data-select2-id="30">
                        <div class="form-group" data-select2-id="29">
                            ...
                            <select name="idTipoIncidencia" id="evento"
                                ...
                                <option value="{{$incidencia->tipoIncidencia->id}}" title="Seleccione el tipo">{{$incidencia->tipoIncidencia->descripcion}} (actual)</option>
                    ...
                    <div class="col-md-2" data-select2-id="30">
                        <div class="form-group" data-select2-id="29">
                            ...
                            <select name="prioridad" id="prioridad"
                                ...
                                <option value="{{$incidencia->prioridad}}" title="Seleccionar Prioridad">{{$incidencia->prioridad}}</option>
                    ...
                    <div class="col-md-2" data-select2-id="30">
                        <div class="form-group" data-select2-id="29">
                            ...
                            <select name="idEstado" id="estado"
                                class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                                data-select2-id="1" tabindex="-1" aria-hidden="true">
                                <option value="{{$incidencia->estado->id}}" title="Seleccione Estado">{{$incidencia->estado->descripcion}}</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="titulo" class="form-control"
                                placeholder="Titulo de la Incidencia" readonly="readonly" value="{{$incidencia->titulo}}">
                            @error('titulo')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group" data-select2-id="29">
                            ...
                            <select name="idAsignadoA" class="form-control select2 select2-hidden-accessible"
                                ...
                                <option selected="selected" data-select2-id="3" title="Asignado para dar solucion">
                                    {{$incidencia->asignadoA->primerNombre}} {{$incidencia->asignadoA->primerApellido}}</option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <textarea readonly="readonly" class="form-control" placeholder="Descripcion de la incidencia" id="descripcion"
                                name="description" style="height: 100px" >{{$incidencia->descripcion}}</textarea>
                            @error('descripcion')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <textarea readonly="readonly" name="observacion" class="form-control" placeholder="Observacion de la incidencia" id="observacion"
                                name="observacion" style="height: 100px" >{{$incidencia->observacion}}</textarea>
                            @error('observacion')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <textarea readonly="readonly" class="form-control" placeholder="Descripcion de la incidencia" id="comentario"
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <textarea name="nuevocomentario" class="form-control" placeholder="Observacion de la incidencia" id="observacion"
                                name="nuevocomentario" style="height: 100px" ></textarea>
